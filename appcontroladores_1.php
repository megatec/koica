...
require \$_SERVER[\"DOCUMENT_ROOT\"].\"/$folder/coneccion.php\";
...
public function borrar(\$id){
    \$con=new coneccion();            
    \$con->Conectar();
    \$sql= \"DELETE FROM ".str_replace("_", "", $tabla[0])." WHERE id=\".\$id.\";\";
