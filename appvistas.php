...
if(!file_exists("vistas")){
 ...
 while ($tabla = mysql_fetch_array($ser)){ 
    ...
    fputs($fp, "<?php require_once  \"Mformulario.php\" ?>
...
<?php require_once  \$_SERVER[\"DOCUMENT_ROOT\"].\"/$folder/pie.php\"; ?>
");
...
<?php require_once  \$_SERVER[\"DOCUMENT_ROOT\"].\"/$folder/encabezado.php\"; ?>  
<?php require_once  \$_SERVER[\"DOCUMENT_ROOT\"].\"/$folder/modelos/".$nomT.".php\"; ?> 
<?php require_once  \$_SERVER[\"DOCUMENT_ROOT\"].\"/$folder/coneccion.php\"; ?> 
<?php 
\$objCon=new controles();
...
chmod("vistas", 0777);
 while ($tabla = mysql_fetch_array($ser)){     
    ...
    fputs($fp,"<?php 
require_once  \$_SERVER[\"DOCUMENT_ROOT\"].\"/$folder/controladores/".$nomT.".php\";
    require_once  \$_SERVER[\"DOCUMENT_ROOT\"].\"/$folder/controles.php\";
...
function accciones($bdd,$folder){
    ...
    while ($tabla = mysql_fetch_array($ser)){
        ...
        fputs($fp, "<?php require_once  \$_SERVER[\"DOCUMENT_ROOT\"].\"/$folder/encabezado.php\"; ?> 
<script>
	$(function() {		
...
<div id='mensaje'>
<?php require_once  \$_SERVER[\"DOCUMENT_ROOT\"].\"/$folder/controladores/".$nomT.".php\";
...
?>
<form action="appvistas.php" method="POST">
